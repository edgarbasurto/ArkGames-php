...
class Servidores extends enum{
    ...
    public static function getName(int $value)
    {
        switch($value)
        {
            case 0: return "E.E.U.U. - California";
            case 1: return "E.E.U.U. - Miami";
            case 2: return "America del Sur";
            case 3: return  "Europa - Oriente";
            case 4: return "Europa - Occidente";
            case 5: return"Asia -  Central";
            case 6: return"Otros";
        }
    } 
}  
