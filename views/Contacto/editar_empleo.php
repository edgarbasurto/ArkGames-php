    ...
    <main class="main p-5 mx-3">
        <div class="container px-5">
            <div class="container card shadow">
                <form id="form_solicitud" method="POST" action="index.php?c=empleo&a=guardar&id=<?php echo $empleo->id_solictudEmpleo?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-1">
                                <input id="id" class="form-control" type="text" name="id" readonly value="<?php echo $empleo->id_solictudEmpleo?>" /> <br>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-2 text-end">
