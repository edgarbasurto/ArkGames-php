                ...
                <div>
                    <p>ciudad:</p>
                        <select class="controls_2" id="ciudad" name="ciudad" disabled>
                                ...
                                <option value="Guayaquil" <?php if($fila['ciudad'] == "Guayaquil"){ echo " selected"; }?>>Guayaquil</option>
                                <option value="Quito" <?php if($fila['ciudad'] == "Quito"){ echo " selected"; }?>>Quito</option>
                                <option value="Portiviejo" <?php if($fila['Portiviejo'] == "Portiviejo"){ echo " selected"; }?>>Portiviejo</option>
                                <option value="Loja" <?php if($fila['ciudad'] == "Loja"){ echo " selected"; }?>>Loja</option>
                                <option value="Otros" <?php if($fila['ciudad'] == "Otros"){ echo " selected"; }?>>Otros</option>
                        </select>
                </div>
