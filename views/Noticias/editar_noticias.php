<?php require_once '../../views/Templates/HeadBootstrap.php' ?>
    ...
    <body>
                        ...
                        <form id="form_suscripcion" method="post">
                            ...
                            <div class="grupo_datos">
                                ...
                                <div>
                                    ...
                                    ?>
                                    <input class="formItem tema" type="checkbox" name="chkbtema[]" value="Novedades"
                                    <?php if(str_contains($fila['temas'], "Novedades")) echo 'checked';?>/> Novedades <br>
                                    <input class="formItem tema" type="checkbox" name="chkbtema[]" value="Eventos" 
                                    <?php if(str_contains($fila['temas'], "Eventos")) echo 'checked';?>/> Eventos <br>
                                    <input class="formItem tema" type="checkbox" name="chkbtema[]" value="Descuentos"
                                    <?php if(str_contains($fila['temas'], "Descuentos")) echo 'checked';?>/> Descuentos <br>
                                    <input class="formItem tema" type="checkbox" name="chkbtema[]" value="Torneos"
                                    <?php if(str_contains($fila['temas'], "Torneos")) echo 'checked';?>/> Torneos <br>
                                    <input class="formItem tema" type="checkbox" name="chkbtema[]" value="Análisis"
                                    <?php if(str_contains($fila['temas'], "Análisis")) echo 'checked';?>/> Análisis <br>
                                    <input class="formItem tema" type="checkbox" name="chkbtema[]" value="Trucos"
                                    <?php if(str_contains($fila['temas'], "Trucos")) echo 'checked';?>/> Trucos <br>
                                </div>
                                <!--<?php
                                    //$temas = ["Novedades", "Eventos", "Descuentos", "Torneos","Análisis","Trucos"];
                                    //$temas_devueltos = explode(", ", $fila['temas']);
                            ...
                            <div class="grupo_datos">
                                ...
                                <div>
                                    <input class="formItem dispositivo" type="checkbox" name="chkbdispositivo[]" value="PC"
                                    <?php if(str_contains($fila['dispositivos'], "PC")) echo 'checked';?>/> PC <br>
                                    <input class="formItem dispositivo" type="checkbox" name="chkbdispositivo[]" value="PS2 - PS3 - PS4 - PS5"
                                    <?php if(str_contains($fila['dispositivos'], "PS2 - PS3 - PS4 - PS5")) echo 'checked';?>/> PS2 - PS3 - PS4 - PS5 <br>
                                    <input class="formItem dispositivo" type="checkbox" name="chkbdispositivo[]" value="XBox"
                                    <?php if(str_contains($fila['dispositivos'], "XBox")) echo 'checked';?>/> XBox <br>
                                    <input class="formItem dispositivo" type="checkbox" name="chkbdispositivo[]" value="Wii"
                                    <?php if(str_contains($fila['dispositivos'], "Wii")) echo 'checked';?>/> Wii <br>
                                    <input class="formItem dispositivo" type="checkbox" name="chkbdispositivo[]" value="Android"
                                    <?php if(str_contains($fila['dispositivos'], "Android")) echo 'checked';?>/> Android <br>
                                </div>
                                <!--<?php
        ...
        ?>
        <?php
        if (!empty($_POST['txtid']) && !empty($_POST['txtemail']) && isset($_POST['chkbtema'])  &&
