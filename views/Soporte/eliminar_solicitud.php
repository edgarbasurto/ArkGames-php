            ...
            <form id="Soporte" method="post">
                <fieldset>
                    ...
                    <div class="frm_campos">
                        ...
                        <div>
                            <p>Usuario:</p>
                            <input class="controls_2" type="text" name="txtusuario" readonly id="usuario" value="<?php echo $fila['usuario'] ?>">
                        </div>
                        ...
                        <div>
                            <p>Servicios:</p>
                            <select class="controls_2" id="servicios" name="servicio" disabled>
                        ...
                        <div>
                            <p>Producto:</p>
                            <select class="controls_2" id="juegos" name="producto" disabled>
                                <option value="0">Seleccione...</option>
                        ...
                        <div>
                            ...
                            <textarea name="txtdescripcion" cols="60" rows="10" disabled><?php echo htmlspecialchars($fila['descripcion_problema']); ?></textarea>
                        </div>
