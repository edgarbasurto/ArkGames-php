     ...
     <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarResponsive">
             <ul class="navbar-nav ms-auto">
                 ...
                 <li class="nav-item mx-0 mx-lg-1">
                     <a class="nav-link py-3 px-0 px-lg-3 rounded" href="index.php?c=noticias&a=index_noticias">
                         <svg class="bi d-inline-block align-text-top mx-auto mb-1" width="24" height="24">
                 ...
                 <?php
                    ...
                    if (PermisosDAO::TIENE_PERMISO(PERMISOS::PUEDE_ACCEDER_MANTENIMIENTO)) {
                        echo '<li class="nav-item mx-0 mx-lg-1">
                     <a class="nav-link py-3 px-0 px-lg-3 rounded" href="index.php?c=session&a=dash">
                         <svg class="bi d-inline-block align-text-top mx-auto mb-1" width="24" height="24">
                             <use xlink:href="#people-circle" />
                         </svg>
                         Mantenimiento</a>
